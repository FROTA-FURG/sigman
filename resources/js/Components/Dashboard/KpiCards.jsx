        ...
        <>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
               ...
               <div className="overflow-hidden rounded-xl bg-[#0b203c]/90 p-2.5 shadow-xl ring-1 ring-slate-800 backdrop-blur-md transition hover:ring-blue-500">
                ...
                <div className="overflow-hidden rounded-xl bg-[#0b203c]/90 p-2.5 shadow-xl ring-1 ring-slate-800 backdrop-blur-md transition hover:ring-orange-500">
                    <div className="flex items-center justify-between">
                        <div>
                ...
                <div className="overflow-hidden rounded-xl bg-[#0b203c]/90 p-2.5 shadow-xl ring-1 ring-slate-800 backdrop-blur-md transition hover:ring-blue-400">
                    <div className="flex items-center justify-between">
                        <div>
